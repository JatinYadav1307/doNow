...
class HabitsControllerTest < ActionController::TestCase
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post :create, habit: { difficulty: @habit.difficulty, notes: @habit.notes, streak: @habit.streak, title: @habit.title }
    end
  ...
  test "should update habit" do
    patch :update, id: @habit, habit: { difficulty: @habit.difficulty, notes: @habit.notes, streak: @habit.streak, title: @habit.title }
    assert_redirected_to habit_path(assigns(:habit))
  end
